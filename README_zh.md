...
6. 在应用密钥的位置填写你的应用签名，记住你的*商户ID*；

# 用例

1. 打开`plugins/android.json`，将$weixin_api_key 修改成你的 *AppID*；

2. 打开`src/android/com/justep/base/Constants.java`, 将 PACKNAME, ACTIVITYCLASSNAME, APPNAME 赋上你的APP 的值，将APPID, PARTNERID, APIKEY 赋值 *AppID*, *商户ID*, *应用签名*;
